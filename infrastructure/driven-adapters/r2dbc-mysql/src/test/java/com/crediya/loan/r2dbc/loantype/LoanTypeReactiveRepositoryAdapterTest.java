//package com.crediya.loan.r2dbc.loantype;
//
...
//import com.crediya.loan.r2dbc.lonType.LoanTypeReactiveRepository; // repo está en 'lonType'
//import com.crediya.loan.r2dbc.loantype.LoanTypeReactiveRepositoryAdapter;
...
//
//// El test ha sido comentado porque no compila
//class LoanTypeReactiveRepositoryAdapterTest {
//
//    // Este test está comentado porque no compila correctamente.
//    // La clase LoanTypeReactiveRepositoryAdapter no se encuentra disponible.
//
//    /*
//    @ExtendWith(MockitoExtension.class)
//    class InnerLoanTypeReactiveRepositoryAdapterTest {
//
//        @Mock
...
//            // 👇 fuerza el overload findById(ID) y hace match con la invocación real
//            when(repository.findById((Long) null)).thenReturn(Mono.empty());
//
//            StepVerifier.create(adapter.findById(null))
//                    .verifyComplete();
//
//            verify(repository, times(1)).findById((Long) null);
